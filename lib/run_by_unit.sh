NHDPlusBurnLineEvent_subset#!/bin/bash
...
ogr2ogr -f GPKG $outputDataDir/wbd.gpkg $inputDataDir/NHDPLUS_H_1209_HU4_GDB.gdb WBDHU6 -where "HUC6='120903'"
Tcount
...
date -u
Tstart
[ ! -f $outputDataDir/NHDPlusBurnLineEvent_subset.gpkg ] && \
$libDir/snap_and_clip_to_nhd.py -o -d 120903 -p "$PROJ" -w $nwmDir/nwm_headwaters_proj.gpkg -s $inputDataDir/NHDPlusBurnLineEvent_1209.gpkg  -v $inputDataDir/NHDPlusFlowlineVAA_1209.gpkg -l $nwmDir/nwm_lakes_proj.gpkg -u $outputDataDir/wbd_projected.gpkg -c $outputDataDir/NHDPlusBurnLineEvent_subset.gpkg -a $outputDataDir/nwm_lakes_proj_120903.gpkg -t $outputDataDir/nwm_headwaters_proj_120903.gpkg -m $nwmDir/nwm_catchments_proj.gpkg -n $outputDataDir/nwm_catchments_proj_120903.gpkg -e $outputDataDir/nhd_headwater_points.gpkg 
Tcount
...
# Tstart
# [ ! -f $outputDataDir/NHDPlusBurnLineEvent_subset.gpkg ] && \
# $taudemDir/streamnet -p $outputDataDir/flowdir_d8_burned_filled.tif  -fel $outputDataDir/dem_thalwegCond.tif -ad8 $outputDataDir/flowaccum_d8_burned_filled.tif -src $outputDataDir/demDerived_streamPixels.tif -ord $outputDataDir/streamOrder.tif -tree $outputDataDir/treeFile.txt -coord $outputDataDir/coordFile.txt -w $outputDataDir/sn_catchments_reaches.tif -net $outputDataDir/NHDPlusBurnLineEvent_subset.gpkg
# Tcount
...
date -u
Tstart
[ ! -f $outputDataDir/NHDPlusBurnLineEvent_subset_split.gpkg ] && \
$libDir/split_flows.py $outputDataDir/NHDPlusBurnLineEvent_subset.gpkg "$PROJ" $outputDataDir/dem_thalwegCond.tif $outputDataDir/NHDPlusBurnLineEvent_subset_split.gpkg $outputDataDir/NHDPlusBurnLineEvent_subset_split_points.gpkg $maxSplitDistance_meters $manning_n $slope_min
Tcount

## RASTERIZE HYDROIDS ##
echo -e $startDiv"Rasterize HydroIDs"$stopDiv
date -u
Tstart
[ ! -f $outputDataDir/flows_grid_hydroIDs.tif ] && \
gdal_rasterize -ot Int32 -a 'HydroID' -init 0 -co "COMPRESS=LZW" -co "BIGTIFF=YES" -co "TILED=YES" -te $xmin $ymin $xmax $ymax -ts $ncols $nrows $outputDataDir/NHDPlusBurnLineEvent_subset_split.gpkg $outputDataDir/flows_grid_hydroIDs.tif
Tcount

## VECTORIZE REACH ID CENTROIDS ##
echo -e $startDiv"Vectorize Reach Centroids"$stopDiv
date -u
Tstart
[ ! -f $outputDataDir/flows_points_reaches.gpkg ] && \
$libDir/reachID_grid_to_vector_points.py $outputDataDir/flows_grid_hydroIDs.tif $outputDataDir/flows_points_reaches.gpkg reachID
Tcount
...
mpiexec -n $ncores_gw $taudemDir/gagewatershed -p $outputDataDir/flowdir_d8_burned_filled.tif -gw $outputDataDir/gw_catchments_reaches.tif -o $outputDataDir/flows_points_reaches.gpkg -id $outputDataDir/idFile.txt
Tcount
...
date -u
Tstart
[ ! -f $outputDataDir/NHDPlusBurnLineEvent_subset_split_clipped.gpkg ] && \
ogr2ogr -progress -f GPKG -clipsrc $outputDataDir/wbd_projected.gpkg $outputDataDir/NHDPlusBurnLineEvent_subset_split_clipped.gpkg $outputDataDir/NHDPlusBurnLineEvent_subset_split.gpkg
Tcount
...
$libDir/filter_catchments_and_add_attributes.py $outputDataDir/gw_catchments_reaches_clipped.gpkg $outputDataDir/NHDPlusBurnLineEvent_subset_split_clipped.gpkg $outputDataDir/gw_catchments_reaches_clipped_addedAttributes.gpkg
Tcount
...
date -u
Tstart
$libDir/make_stages_and_catchlist.py $outputDataDir/NHDPlusBurnLineEvent_subset_split_clipped.gpkg $outputDataDir/gw_catchments_reaches_clipped_addedAttributes.gpkg $outputDataDir/stage.txt $outputDataDir/catchment_list.txt $stage_min_meters $stage_interval_meters $stage_max_meters
Tcount
...
$libDir/add_crosswalk.py $outputDataDir/gw_catchments_reaches_clipped_addedAttributes.gpkg $outputDataDir/NHDPlusBurnLineEvent_subset_split_clipped.gpkg $outputDataDir/src_full.csv $outputDataDir/majority.geojson $outputDataDir/gw_catchments_reaches_clipped_addedAttributes_crosswalked.gpkg $outputDataDir/NHDPlusBurnLineEvent_subset_split_clipped_addedAttributes_crosswalked.gpkg $outputDataDir/src_full_crosswalked.csv $outputDataDir/src.json $outputDataDir/crosswalk_table.csv
Tcount
