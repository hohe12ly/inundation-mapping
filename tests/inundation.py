...
def inundate(
    ...
    elif isinstance(catchment_poly,gpd.geodataframe.GeoDataFrame):
        pass
    else:
        ...
        for huc in hucs:
            ...
            try:
                if mask_type == "huc":
                    ...
                    catchment_poly_fossid=catchment_poly[catchment_poly.HydroID.str.startswith(fossid)]

                    rem_array,window_transform = mask(rem,catchment_poly_fossid['geometry'],crop=True,indexes=1)
                    catchments_array,_ = mask(catchments,catchment_poly_fossid['geometry'],crop=True,indexes=1)
                else:
